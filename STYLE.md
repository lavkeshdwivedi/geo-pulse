# GeoPulse Editorial Style Guide

This file is the authoritative style reference for all GeoPulse summaries.
It is loaded at runtime by `scripts/summarize.py` and fed directly to the LLM prompt,
so any edit here is immediately reflected in the next newsletter run — no code change needed.
