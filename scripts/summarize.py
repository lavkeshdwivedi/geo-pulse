...
REGION_KEYWORDS: dict[str, list[str]] = {
    "Middle East & Africa": [
        ...
        # Hindi (Devanagari)
        "इजरायल", "इजराइल", "फिलिस्तीन", "फ़िलिस्तीन", "गाजा", "ग़ाज़ा",
        "ईरान", "सऊदी", "यमन", "सीरिया", "इराक", "लेबनान", "मिस्र",
        "अफ्रीका", "सूडान", "इथियोपिया", "लीबिया", "तेहरान", "हमास",
        "हूती", "हिज़बुल्लाह", "हिजबुल्लाह",
    ],
    "Europe & Russia": [
        # English
        "ukraine", "russia", "nato", "european union", "france",
        "germany", " uk ", "britain", "poland", "sweden", "finland", "baltics",
        "putin", "zelensky", "moscow", "kyiv", "berlin", "paris", "london",
        # Hindi
        "यूक्रेन", "रूस", "नाटो", "यूरोपीय संघ", "फ्रांस", "जर्मनी",
        "ब्रिटेन", "पोलैंड", "स्वीडन", "फिनलैंड", "पुतिन", "जेलेंस्की",
        "मॉस्को", "कीव", "बर्लिन", "पेरिस", "लंदन",
    ],
    "Asia-Pacific": [
        # English
        "china", "taiwan", "japan", "korea", "india", "pakistan",
        "south china sea", "asean", "indo-pacific", "australia",
        "beijing", "tokyo", "seoul", "delhi", "islamabad",
        # Hindi
        "चीन", "ताइवान", "जापान", "कोरिया", "भारत", "पाकिस्तान",
        "ऑस्ट्रेलिया", "आस्ट्रेलिया", "बीजिंग", "टोक्यो", "सियोल",
        "दिल्ली", "इस्लामाबाद", "श्रीलंका", "नेपाल", "बांग्लादेश",
        "म्यांमार", "फिलीपींस", "इंडोनेशिया", "वियतनाम", "थाईलैंड",
    ],
    "Americas": [
        # English
        "united states", " us ", "usa", "biden", "trump", "canada",
        "mexico", "brazil", "venezuela", "latin america", "washington",
        "white house", "pentagon",
        # Hindi
        "अमेरिका", "संयुक्त राज्य", "यूएस", "यूएसए", "बाइडन", "ट्रंप",
        "कनाडा", "मेक्सिको", "ब्राजील", "ब्राज़ील", "वेनेजुएला",
        "वॉशिंगटन", "वाशिंगटन", "व्हाइट हाउस", "पेंटागन", "अर्जेंटीना",
    ],
    "Global / Multilateral": [
        # English
        ...
        # Hindi
        "संयुक्त राष्ट्र", "यूएन", "जी7", "जी20", "जी-7", "जी-20",
        "डब्ल्यूटीओ", "आईएमएफ", "प्रतिबंध", "कूटनीति", "भू-राजनीति",
