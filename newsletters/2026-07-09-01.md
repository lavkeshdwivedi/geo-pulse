...
**Updated:** July 09, 2026 07:09 IST
...
Crisis Group analysts monitor global conflicts and crises weekly. They identify under-reported trends and headline-grabbing developments. The team features hotspots around the globe in their On Our Radar series. Field experts explain the significance of these events. On Our Radar scans conflicts and crises around the globe every week and features some of the hotspots Crisis Group’s analysts are closely watching.
...
A software glitch caused a mass outage affecting Telstra services, impacting mobiles, trains, and triple-zero calls. The issue led to a Victoria train stoppage, with the regional train network grinding to a halt. A long list of trains was cancelled, according to the official V/line site. Telstra apologised for the major time-keeping issue. This blog is now closedTelstra outage: Telco apologises for major time-keeping issue that hit mobiles, trains and triple-zero callsGet our breaking news email, free app or daily news podcastTelstra outage reported to be cause of Victoria train stoppageThere is a long list of cancelled trains on the official V/line site, but the TL/DR is that Victoria’s regional train network has ground to a halt. D.
